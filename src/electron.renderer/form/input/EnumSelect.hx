...
class EnumSelect<T:EnumValue> extends form.Input<T> {
	...
	public function new(j:js.jquery.JQuery, e:Enum<T>, allowNull=false, getter:Void->T, setter:T->Void, ?nameLocalizer:T->dn.data.LocaleString, ?keepOnly:T->Bool, disableFilteredOuts=false) {
